        ...
        <div class="Sidebar">
          <div class="visitorProfile">
            <div class="visitorProfileHeader">
              ...
              />
              <span>{{visitorProfile.nick}}</span>
            </div>
            <div class="visitorProfileBody">
              <div class="visitorProfileNav">
                <el-button v-if="logDialogProps.isLog" @click="jumpVisitorProfile">Your Profile</el-button>
